...
Target machine: **Frontier at ORNL** (AMD MI300A, `gfx942`).

## Prerequisites

Same as the [MACE standalone guide](mace.md). In addition, `cmake/3.29.2` is needed for the LAMMPS build step.
...
### 2. Create virtual environment and install PyTorch + MACE
...
### 4. Find CMake paths (helper)

Run this inside your activated environment to get the correct paths:
...
### 5. Install symmetrix into LAMMPS source
